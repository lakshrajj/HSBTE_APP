...
public class QueAdapter2 extends FirebaseRecyclerAdapter<model2,QueAdapter2.myviewholder>
{
    String sem,sub;


    public QueAdapter2(@NonNull FirebaseRecyclerOptions<model2> optionss) {
        super(optionss);

    }

    public void getSubSem(String semm){
        sem=semm;
    ...
    @Override
    protected void onBindViewHolder(@NonNull myviewholder holder,final int position, @NonNull model2 model2)
    {
       /* String sem,sub;
            ...
            public void onClick(View v) {
                ...
                submit.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        FirebaseDatabase.getInstance().getReference(sem).child(getRef(position).getKey()).updateChildren(map)
            ...
            public void onClick(View v) {
                ...
                builder.setPositiveButton("Yes, Delete", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        FirebaseDatabase.getInstance().getReference(sem)
        ...
        String newss=model2.getQue().toString().replace("_n","\n");
